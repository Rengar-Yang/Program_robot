...
extern u8 Flag_Left,Flag_Right,Flag_Direction,Flag_Way,Flag_Next,Turn_Flag;   //蓝牙遥控相关的变量
...
extern float Position_Rate_X,Position_Rate_Y;
extern s8 Position_MX,Position_MY,Position_X,Position_Y,Position_Z;
extern long int Target_X,Target_Y;
...
extern float Velocity_KP,Velocity_KI,Angle_KP,Angle_KI,Angle_KD;	          //速度控制PID参数
extern float r,error_p,error_i,error_d,last_angle,angle_speed;
extern float P_error_pX,P_error_pY,P_error_i,P_error_d,P_speed,last_Position,p_rx,p_ry;//位置PID中间变量
extern float	target_yaw;//目标角度
